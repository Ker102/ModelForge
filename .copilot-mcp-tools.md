...
- ⚠️ **AVOID `browser_take_screenshot`** — it's very slow. Ask the user to visually verify UI instead.
- **Use for**: Console error checking, reading DOM state, quick form fills, network request inspection
- **Don't use for**: Visual verification of UI appearance — ask the user to check that
