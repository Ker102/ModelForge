ContentsMenuExpandLight modeDark modeAuto light/dark, in light modeAuto light/dark, in dark mode[Skip to content](https://docs.blender.org/api/current/bpy.types.PointLight.html#furo-main-content)

[Back to top](https://docs.blender.org/api/current/bpy.types.PointLight.html#)

Toggle Light / Dark / Auto color theme

Toggle table of contents sidebar

# PointLight(Light) [¶](https://docs.blender.org/api/current/bpy.types.PointLight.html\#pointlight-light "Link to this heading")
...
_class_ bpy.types.PointLight( _Light_) [¶](https://docs.blender.org/api/current/bpy.types.PointLight.html#bpy.types.PointLight "Link to this definition")

Omnidirectional point Light

energy [¶](https://docs.blender.org/api/current/bpy.types.PointLight.html#bpy.types.PointLight.energy "Link to this definition")
...
shadow\_buffer\_clip\_start [¶](https://docs.blender.org/api/current/bpy.types.PointLight.html#bpy.types.PointLight.shadow_buffer_clip_start "Link to this definition")
...
shadow\_filter\_radius [¶](https://docs.blender.org/api/current/bpy.types.PointLight.html#bpy.types.PointLight.shadow_filter_radius "Link to this definition")
...
shadow\_jitter\_overblur [¶](https://docs.blender.org/api/current/bpy.types.PointLight.html#bpy.types.PointLight.shadow_jitter_overblur "Link to this definition")
...
shadow\_maximum\_resolution [¶](https://docs.blender.org/api/current/bpy.types.PointLight.html#bpy.types.PointLight.shadow_maximum_resolution "Link to this definition")
...
shadow\_soft\_size [¶](https://docs.blender.org/api/current/bpy.types.PointLight.html#bpy.types.PointLight.shadow_soft_size "Link to this definition")
...
use\_absolute\_resolution [¶](https://docs.blender.org/api/current/bpy.types.PointLight.html#bpy.types.PointLight.use_absolute_resolution "Link to this definition")
...
use\_shadow\_jitter [¶](https://docs.blender.org/api/current/bpy.types.PointLight.html#bpy.types.PointLight.use_shadow_jitter "Link to this definition")
...
use\_soft\_falloff [¶](https://docs.blender.org/api/current/bpy.types.PointLight.html#bpy.types.PointLight.use_soft_falloff "Link to this definition")
...
inline\_shader\_nodes() [¶](https://docs.blender.org/api/current/bpy.types.PointLight.html#bpy.types.PointLight.inline_shader_nodes "Link to this definition")
...
_classmethod_ bl\_rna\_get\_subclass( _id_, _default=None_, _/_) [¶](https://docs.blender.org/api/current/bpy.types.PointLight.html#bpy.types.PointLight.bl_rna_get_subclass "Link to this definition")Parameters:
...
_classmethod_ bl\_rna\_get\_subclass\_py( _id_, _default=None_, _/_) [¶](https://docs.blender.org/api/current/bpy.types.PointLight.html#bpy.types.PointLight.bl_rna_get_subclass_py "Link to this definition")Parameters:
...
## Inherited Properties [¶](https://docs.blender.org/api/current/bpy.types.PointLight.html\#inherited-properties "Link to this heading")
...
## Inherited Functions [¶](https://docs.blender.org/api/current/bpy.types.PointLight.html\#inherited-functions "Link to this heading")
