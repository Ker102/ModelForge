ContentsMenuExpandLight modeDark modeAuto light/dark, in light modeAuto light/dark, in dark mode[Skip to content](https://docs.blender.org/api/current/bpy.types.ShaderNodeTexNoise.html#furo-main-content)

[Back to top](https://docs.blender.org/api/current/bpy.types.ShaderNodeTexNoise.html#)

Toggle Light / Dark / Auto color theme

Toggle table of contents sidebar

# ShaderNodeTexNoise(ShaderNode) [¶](https://docs.blender.org/api/current/bpy.types.ShaderNodeTexNoise.html\#shadernodetexnoise-shadernode "Link to this heading")
...
_class_ bpy.types.ShaderNodeTexNoise( _ShaderNode_) [¶](https://docs.blender.org/api/current/bpy.types.ShaderNodeTexNoise.html#bpy.types.ShaderNodeTexNoise "Link to this definition")

Generate fractal Perlin noise

color\_mapping [¶](https://docs.blender.org/api/current/bpy.types.ShaderNodeTexNoise.html#bpy.types.ShaderNodeTexNoise.color_mapping "Link to this definition")

Color mapping settings

Type:

[`ColorMapping`](https://docs.blender.org/api/current/bpy.types.ColorMapping.html#bpy.types.ColorMapping "bpy.types.ColorMapping"), (readonly, never None)

noise\_dimensions [¶](https://docs.blender.org/api/current/bpy.types.ShaderNodeTexNoise.html#bpy.types.ShaderNodeTexNoise.noise_dimensions "Link to this definition")
...
noise\_type [¶](https://docs.blender.org/api/current/bpy.types.ShaderNodeTexNoise.html#bpy.types.ShaderNodeTexNoise.noise_type "Link to this definition")
...
normalize [¶](https://docs.blender.org/api/current/bpy.types.ShaderNodeTexNoise.html#bpy.types.ShaderNodeTexNoise.normalize "Link to this definition")
...
texture\_mapping [¶](https://docs.blender.org/api/current/bpy.types.ShaderNodeTexNoise.html#bpy.types.ShaderNodeTexNoise.texture_mapping "Link to this definition")

Texture coordinate mapping settings

Type:

[`TexMapping`](https://docs.blender.org/api/current/bpy.types.TexMapping.html#bpy.types.TexMapping "bpy.types.TexMapping"), (readonly, never None)

_classmethod_ is\_registered\_node\_type() [¶](https://docs.blender.org/api/current/bpy.types.ShaderNodeTexNoise.html#bpy.types.ShaderNodeTexNoise.is_registered_node_type "Link to this definition")
...
_classmethod_ input\_template( _index_) [¶](https://docs.blender.org/api/current/bpy.types.ShaderNodeTexNoise.html#bpy.types.ShaderNodeTexNoise.input_template "Link to this definition")
...
_classmethod_ output\_template( _index_) [¶](https://docs.blender.org/api/current/bpy.types.ShaderNodeTexNoise.html#bpy.types.ShaderNodeTexNoise.output_template "Link to this definition")
...
_classmethod_ bl\_rna\_get\_subclass( _id_, _default=None_, _/_) [¶](https://docs.blender.org/api/current/bpy.types.ShaderNodeTexNoise.html#bpy.types.ShaderNodeTexNoise.bl_rna_get_subclass "Link to this definition")Parameters:
...
_classmethod_ bl\_rna\_get\_subclass\_py( _id_, _default=None_, _/_) [¶](https://docs.blender.org/api/current/bpy.types.ShaderNodeTexNoise.html#bpy.types.ShaderNodeTexNoise.bl_rna_get_subclass_py "Link to this definition")Parameters:
...
## Inherited Properties [¶](https://docs.blender.org/api/current/bpy.types.ShaderNodeTexNoise.html\#inherited-properties "Link to this heading")
...
## Inherited Functions [¶](https://docs.blender.org/api/current/bpy.types.ShaderNodeTexNoise.html\#inherited-functions "Link to this heading")
